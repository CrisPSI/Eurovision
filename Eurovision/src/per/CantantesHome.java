...
public class CantantesHome {
	...
	public Cantantes findById(java.lang.String id) {
		...
		try {
			Cantantes instance = (Cantantes) sessionFactory.getCurrentSession().get("per.Cantantes", id);
			if (instance == null) {
	...
	public List findByExample(Cantantes instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("per.Cantantes")
